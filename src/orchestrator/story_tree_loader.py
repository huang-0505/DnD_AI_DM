...
class StoryTree:
    ...
    def find_node_by_keywords(self, keywords: List[str], current_node_id: Optional[str] = None) -> Optional[StoryNode]:
        ...
        search_nodes = [self.nodes[current_node_id]] if current_node_id and current_node_id in self.nodes else list(self.nodes.values())
...
class StoryTreeLoader:
    ...
    def get_available_story_trees() -> List[str]:
        ...
        return [
            f.stem for f in StoryTreeLoader.STORY_TREES_DIR.glob("*.json")
        ]
            ...
            "nodes": [
                ...
                },
                {
                    ...
                    "choices": [
                        ...
                        "Continue exploring the main paths"
                    ],
                    "is_ending": False,
                    "children": {
